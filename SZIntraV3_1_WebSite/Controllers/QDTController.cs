...
namespace SZIntraV3_1_WebSite.Controllers
{
    public class QDTController : DirectHelper
    {
        ...
        private void CreateDrPdf(string dr_num, string outFileDict)
        {
            ...
            Paragraph version = new Paragraph("GE Aviation Suzhou F8700-006  ISSUE:05", font_table_name);// Update by Shirley 2017-04-19
            ...
            // document.Add(dispositionTable);
            document.Add(new Phrase("                                     如果零件报废,确认是否有配件", font_Context));// Update by Shirley 2017-04-19
            document.Add(p_blank);
